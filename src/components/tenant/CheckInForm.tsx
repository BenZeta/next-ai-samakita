    ...
    <div className="space-y-6">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-muted-foreground">
            {t('tenants.checkIn.form.itemName')}
          </label>
          ...
          {errors.itemName && (
            <p className="mt-1 text-sm text-destructive">
              {t('tenants.checkIn.form.validation.itemName')}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.condition && (
            <p className="mt-1 text-sm text-destructive">
              {t('tenants.checkIn.form.validation.condition')}
            </p>
          )}
        </div>
      ...
      <div>
        <h3 className="text-lg font-medium text-foreground">
          {t('tenants.checkIn.form.items.title')}
        </h3>
        <div className="mt-4 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t('tenants.checkIn.form.items.condition')} {item.condition}
                  </p>
          ...
          {checkInItems?.length === 0 && (
            <p className="text-center text-muted-foreground">
              {t('tenants.checkIn.form.items.noItems')}
            </p>
          )}
        </div>
      </div>
