...
export function RoomList({ propertyId }: RoomListProps) {
  const [selectedStatus, setSelectedStatus] = useState<"available" | "occupied" | "maintenance" | undefined>();
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <select
            ...
            onChange={(e) => setSelectedStatus(e.target.value ? (e.target.value as "available" | "occupied" | "maintenance") : undefined)}
